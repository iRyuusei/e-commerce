                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown user-box">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                                    <li><a href="<?php echo base_url() ?>index.php/Login/accounts"></i> Profile</a></li>
                                    <li><a href="<?php echo base_url() ?>index.php/Login/edit_accounts"><i class="ti-power-off m-r-5"></i>Edit Information</a></li>
